function App(){
    ...
    return(
        <div className="App">
            <h2> Change 이벤트 </h2>
            <input id="input_box" type="text" placeholder="여기에 작성" autoFocus onChange={ChangeEvent}/>
            <br/>
            ...
            <br/>
            {/* alt 속성은 해당 이미지가 없을 때 보여주는 글자를 지정하는 속성 */}
